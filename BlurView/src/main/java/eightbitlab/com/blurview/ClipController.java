 ...
 */
class ClipController implements BlurController {
    private static final String TAG = ClipController.class.getSimpleName();
    //Bitmap size should be divisible by 16 to meet stride requirement
    private static final int ROUNDING_VALUE = 36;
    ...
    private boolean shouldTryToOffsetCoords = false;
     ...
     */
    ClipController(@NonNull View blurView, @NonNull ViewGroup rootView, int scaleFactor) {
    ...
    private void setupInternalCanvasMatrix() {
        ...
        internalCanvas.scale(1f / scaleFactorX, 1.1f / scaleFactorY);
    }
